...
def job_type_and_location_data(cfg):
 ...
 #dblist=db_connection.list_database_names()
  ...
  df =sqlC.sql("SELECT count(*) as job_count,job_type,job_place from data group by job_type,job_place")
  ...
  if "LinkedInJob" in dblist:
    ...
    db_cm = mydb["job_type_and_location"]
